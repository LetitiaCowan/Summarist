...
const ChosenPlanClientWrapper = () => {
    ...
    const handleSubscribe = () => {
      ...
      console.log(`Subscribing to ${currentPlan.name} plan (${billingCycle})`);
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="row py-16">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-200 mb-8 leading-relaxed">
              Get instant access to thousands of book summaries, audio content, and personalized recommendations. 
            ...
            <div className="flex items-center justify-center gap-4 mb-8">
              ...
              <div className="flex items-center gap-2">
                <BiShield className="text-green-400 text-xl" />
                <span className="font-semibold">30-day guarantee</span>
              </div>
              <div className="w-px h-6 bg-gray-400"></div>
              <div className="flex items-center gap-2">
                <BiHeadphone className="text-blue-400 text-xl" />
      ...
      <div className="row py-16">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-[#032b41] mb-4">
            Choose Your Plan
          </h2>
          <p className="text-xl text-[#394547] mb-8">
            Start with a free trial, cancel anytime
          </p>
          
          {/* Billing Toggle */}
          <div className="flex items-center justify-center gap-4 mb-12">
            <span className={`text-lg font-medium ${billingCycle === 'monthly' ? 'text-[#032b41]' : 'text-gray-500'}`}>
              Monthly
            </span>
            <button
            ...
            <span className={`text-lg font-medium ${billingCycle === 'yearly' ? 'text-[#032b41]' : 'text-gray-500'}`}>
              Yearly
            </span>
            {billingCycle === 'yearly' && (
              <span className="bg-[#2bd97c] text-[#032b41] px-3 py-1 rounded-full text-sm font-semibold">
                Save 17%
              </span>
            )}
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {/* Basic Plan */}
          <div 
            className={`bg-white rounded-2xl shadow-lg border-2 p-8 cursor-pointer transition-all ${
              selectedPlan === 'basic' ? 'border-[#2bd97c] ring-4 ring-[#2bd97c]/20' : 'border-gray-200 hover:border-gray-300'
            }`}
            onClick={() => setSelectedPlan('basic')}
          >
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-[#032b41] mb-2">Basic</h3>
              <p className="text-[#394547] mb-4">{plans[billingCycle].basic.description}</p>
              <div className="mb-4">
                <span className="text-5xl font-bold text-[#032b41]">
                  ${plans[billingCycle].basic.price}
                </span>
                <span className="text-[#394547] text-lg">/{plans[billingCycle].basic.period}</span>
              </div>
            ...
            <ul className="space-y-4 mb-8">
              {plans[billingCycle].basic.features.map((feature, index) => (
                <li key={index} className="flex items-center gap-3">
                  <BiCheck className="text-[#2bd97c] text-xl flex-shrink-0" />
                  <span className="text-[#394547]">{feature}</span>
                </li>
              ))}
              {plans[billingCycle].basic.limitations.map((limitation, index) => (
                <li key={index} className="flex items-center gap-3">
                  <BiX className="text-gray-400 text-xl flex-shrink-0" />
          ...
          {/* Premium Plan */}
          <div 
            className={`bg-white rounded-2xl shadow-lg border-2 p-8 cursor-pointer transition-all relative ${
          ...
          >
            ...
            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
              <div className="bg-[#2bd97c] text-[#032b41] px-6 py-2 rounded-full font-semibold flex items-center gap-2">
            ...
            <div className="text-center mb-8 pt-4">
              <h3 className="text-2xl font-bold text-[#032b41] mb-2">Premium</h3>
              <p className="text-[#394547] mb-4">{plans[billingCycle].premium.description}</p>
              <div className="mb-4">
                <span className="text-5xl font-bold text-[#032b41]">
                  ${plans[billingCycle].premium.price}
                </span>
                <span className="text-[#394547] text-lg">/{plans[billingCycle].premium.period}</span>
              </div>
      ...
      <div className="bg-white py-16">
        <div className="row">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-[#394547] max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-[#394547]">Access thousands of book summaries across all genres and topics</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-[#032b41] mb-3">Offline Access</h3>
              <p className="text-[#394547]">Download summaries for offline reading and listening</p>
            </div>
      ...
      <div className="bg-gray-50 py-16">
        <div className="row">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-[#394547]">
          ...
          <div className="max-w-3xl mx-auto">
            {faqItems.map((item, index) => (
              <div key={index} className="bg-white rounded-lg shadow-sm border border-gray-200 mb-4">
                ...
                >
                  <span className="text-lg font-semibold text-[#032b41]">{item.question}</span>
                  {openAccordion === `faq-${index}` ? (
                    <FaChevronUp className="text-[#394547]" />
                  ) : (
                    <FaChevronDown className="text-[#394547]" />
                  )}
                </button>
                {openAccordion === `faq-${index}` && (
                  <div className="px-6 pb-4">
                    <p className="text-[#394547] leading-relaxed">{item.answer}</p>
                  </div>
                )}
              </div>
            ))}
          ...
          <div className="text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                ...
                className="bg-[#2bd97c] text-[#032b41] font-semibold px-8 py-4 rounded-xl text-lg hover:bg-[#20ba68] transition-colors"
              >
                Start Your Free Trial
              </button>
              <button 
                onClick={handleBackToLibrary}
                className="bg-transparent border-2 border-white text-white font-semibold px-8 py-4 rounded-xl text-lg hover:bg-white hover:text-[#032b41] transition-colors"
              >
                Back to Library
              </button>
            </div>
